    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medecin', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='utilisateur.employe')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medecin_traitant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='utilisateur.employe')),
            ],
            options={
