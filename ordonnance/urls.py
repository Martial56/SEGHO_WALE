...
urlpatterns = [
    ...
    path('medicaments-dispo/',                views.medicaments_dispo_par_medecin, name='medicaments_dispo_par_medecin'),
    path('nouvelle/',                         views.ordonnance_create_libre,   name='ordonnance_create_libre'),
