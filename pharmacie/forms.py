...
from .models import (
    Medicament, MouvementStock, GroupeMedicament, LigneMedicamentGroupe,
    CompagniePharma, EffetTherapeutique, DosageMedicament, RouteMedicament, FormulaireType,
)
...
class MedicamentForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'quantite_prescription_manuelle',
...
class MouvementStockForm(forms.ModelForm):
    ...
    def __init__(self, *args, medicament=None, **kwargs):
        ...
        if medicament:
            self.fields['lot'].queryset = medicament.lots.all()
...
class GroupeMedicamentForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'maladies': forms.Textarea(attrs={'rows': 2}),
        }
