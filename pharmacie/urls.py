...
urlpatterns = [
    ...
    path('<str:pharmacie>/stock/import/',       views.pharmacie_import_stock_initial,        name='pharmacie_import_stock_initial'),
    path('<str:pharmacie>/stock/import/modele/', views.pharmacie_import_stock_initial_modele, name='pharmacie_import_stock_initial_modele'),
